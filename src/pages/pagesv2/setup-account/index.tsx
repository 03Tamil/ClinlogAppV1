...
import ResendActivationEmailForm from "componentsv2/Signin/ResendActivationEmailForm";
import { error } from "console";
import { set } from "date-fns";
import { gql, GraphQLClient } from "graphql-request";
import { setPassword } from "helpersv2/mutations";
  ...
  useEffect(() => {
    if (session) {
      if (isStaff(session?.groups)) {
        ...
        router.push("/pagesv2/setup-account/details");
      }
    }
  }, [session]);
