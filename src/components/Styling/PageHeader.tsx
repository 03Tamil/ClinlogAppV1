import {AspectRatio, Box, Button, Container, Flex, Grid, GridItem, Heading, Icon, Image, Text} from "@chakra-ui/react";
...
export default function PageHeader({title, subheading, imageUrl, breadcrumbs, justBreadcrumbs}: pageHeaderProps) {
  return(
    <>
      <Flex
