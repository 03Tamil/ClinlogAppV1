...
export default function ProfileImageForm() {
  ...
  const validationSchema = object({
    photo: (
      ...
      .test("type", "Only the following formats are accepted: .png, .jpeg, .jpg, .bmp", (value) => {
        return value && (
      ...
      .test("fileSize", "Max upload 5MB", value => value?.[0]?.size <= 5000000)
    ),
  })
  const formOptions = {
                ...
                <GridItem colSpan={{ base: 1, lg: 4 }}>
                  <FormControl as={"fieldset"}>
                    ...
                    >
                      ...
                      <SkeletonCircle isLoaded={!!formReady} width={"8rem"} height={"8rem"}>
                        <Avatar name={fullName} src={avatarUrl} size="2xl"/>
                      </SkeletonCircle>
                    </Flex>
                  </FormControl>
                </GridItem>
                <GridItem colSpan={{ base: 1, lg: 8 }}>
                  ...
                  >
                    ...
                    {errors?.photo?.message ? (
                      <FormHelperText color={"red"}>{errors.photo.message.toString()}</FormHelperText>
                    ) : null}
                  </FormControl>
                </GridItem>
                <GridItem colSpan={{ base: 1, lg: 12 }}>
                  <Flex width={"100%"} justifyContent={"flex-end"}>
                    ...
                    >
                      <chakra.span>Upload Profile Image</chakra.span>
                    </Button>
                  </Flex>
                </GridItem>
              </Grid>
