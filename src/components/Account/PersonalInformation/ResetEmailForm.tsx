  ...
  const formSubmit = useMutation(
    (newData: any) => sendData(updateEmailAddressQuery, newData),
    {
      onSuccess: (data, variables, context) => {
        toast({
          title: "An email has been sent to your new email address. Please check your inbox to confirm the change.",
          status: 'success',
          duration: 9000,
          isClosable: true,
        })
        ...
        >
          ...
          <GridItem colSpan={{ base: 1, lg: 12 }}>
            <Flex width={"100%"} justifyContent={"flex-end"}>
              ...
              >
                <chakra.span>Update Email</chakra.span>
              </Button>
            </Flex>
          </GridItem>
        </Grid>
